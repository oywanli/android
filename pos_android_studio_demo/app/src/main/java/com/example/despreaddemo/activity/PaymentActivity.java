...
import com.example.despreaddemo.ui.dialog.Mydialog;
import com.example.despreaddemo.utils.DUKPK2009_CBC;
import com.example.despreaddemo.utils.FileUtils;
import com.example.despreaddemo.utils.ParseASN1Util;
import com.example.despreaddemo.utils.QPOSUtil;
import com.example.despreaddemo.utils.SharedPreferencesUtil;
import com.example.despreaddemo.utils.TLV;
import com.example.despreaddemo.utils.TLVParser;
import com.example.despreaddemo.utils.TRACE;
import com.example.despreaddemo.utils.USBClass;
import com.example.despreaddemo.utils.Utils;
import com.example.despreaddemo.utils.bluebean;
import com.example.despreaddemo.widget.BluetoothAdapter;
import com.example.despreaddemo.widget.pinpad.PayPassDialog;
import com.example.despreaddemo.widget.pinpad.PayPassView;
import com.example.despreaddemo.widget.pinpad.keyboard.KeyBoardNumInterface;
import com.example.despreaddemo.widget.pinpad.keyboard.KeyboardUtil;
import com.example.despreaddemo.widget.pinpad.keyboard.MyKeyboardView;
...
public class PaymentActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ImageView imgAnimScanbt;
    private View line1;
    private TextView tradeSuccessFlag;
    ...
    public void updateFirmware() {
        if (ActivityCompat.checkSelfPermission(PaymentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                for (String fileName : allFiles) {
                    if (!TextUtils.isEmpty(fileName)) {
                        if (fileName.toUpperCase().endsWith(".asc".toUpperCase())) {
                            ...
                            Toast.makeText(PaymentActivity.this, "Upgrade package path:" +
...
//        pos.clearBluetoothBuffer();
    ...
    private void scanBlue() {
        lvIndicatorBTPOS.setLayoutManager(new LinearLayoutManager(
                PaymentActivity.this, LinearLayoutManager.VERTICAL, false));
        if (m_Adapter == null) {
    ...
    private void initView() {
        ...
        imgAnimScanbt = findViewById(R.id.img_anim_scanbt);
        line1 = findViewById(R.id.line1);
        lvIndicatorBTPOS = findViewById(R.id.lv_indicator_BTPOS);
        tradeSuccessFlag = findViewById(R.id.trade_success_flag);
...
//        Toast.makeText(this, "sdkVersion--" + sdkVersion, Toast.LENGTH_SHORT).show();
        ...
        if (!"".equals(disblue) && disblue != null) {
            mrllayout.setVisibility(View.GONE);
            Log.w("payment", "info0000000000000000");
            if (pos.getBluetoothState()) {
                try {
                    pos.disconnectBT();
                } catch (Exception e) {
...
//                mllchrccard.setVisibility(View.GONE);
    ...
    private void devicePermissionRequest(UsbManager mManager, UsbDevice usbDevice) {
        PendingIntent mPermissionIntent = PendingIntent.getBroadcast(PaymentActivity.this, 0, new Intent(
