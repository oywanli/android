...
import static com.example.despreaddemo.utils.QPOSUtil.HexStringToByteArray;
import static com.example.despreaddemo.utils.QPOSUtil.byteArray2Hex;
...
//        System.out.println("tr31 = "+tr31Data.substring(1));
    ...
    public static String generateNonce() {
        try {
            ...
            String nonce = byteArray2Hex(bytes_key);
            return nonce;
        } catch (Exception e) {
            e.printStackTrace();
        }
