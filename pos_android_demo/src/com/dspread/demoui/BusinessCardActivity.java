...
public class BusinessCardActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buci_activity_main);
        
        writeBtn = (Button)findViewById(R.id.writeBtn);
        readBtn = (Button)findViewById(R.id.readBtn);
        writeEditText = (EditText)findViewById(R.id.wrieEditText);
        statusEditText = (EditText)findViewById(R.id.bEditText);  
//		
...
//    	
    ...
    class MyPosListener implements QPOSServiceListener {
		...
		public void onRequestTransactionResult(TransactionResult transactionResult) {
			...
			dialog = new Dialog(BusinessCardActivity.this);
...
//			dismissDialog();
		...
		public void onRequestSelectEmvApp(ArrayList<String> appList) {
			...
			appListView.setAdapter(new ArrayAdapter<String>(BusinessCardActivity.this, android.R.layout.simple_list_item_1, appNameList));
		...
		public void onClick(View v) {
			...
			if(v == writeBtn) {
				...
				if (data==null || "".equals(data)) {
					statusEditText.setText("write data is null");
					return;
				}
				if (data.length()%2 !=0) {
					data += "F";
				}
				pos.writeBusinessCard("05", "00", data, "FFFFFF", false, 3, 25);
				statusEditText.setText("start write data...");
			}else if(v==readBtn){			
				statusEditText.setText("start read data...");
				pos.readBusinessCard("05", "00", 128, "FFFFFF", 3, 25);
			}
