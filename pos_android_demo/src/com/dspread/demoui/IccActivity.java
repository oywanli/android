...
public class IccActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothAdress = getIntent().getExtras().getString("adress");
...
//    	pos.onDestroy();
    ...
    class MyPosListener implements QPOSServiceListener {
		...
		public void onRequestTransactionResult(TransactionResult transactionResult) {
    		TRACE.d("icc+onRequestTransactionResult");
			dismissDialog();
		...
		public void onRequestBatchData(String tlv) {
			TRACE.d("onRequestBatchData+ICC交易结束");
//			dismissDialog();
		...
		public void onRequestSelectEmvApp(ArrayList<String> appList) {
			TRACE.d("onRequestSelectEmvApp+请选择App -- S");
			dismissDialog();
		...
		public void onRequestIsServerConnected() {
			TRACE.d("onRequestIsServerConnected+在线过程请求");
			dismissDialog();
			dialog = new Dialog(IccActivity.this);
			dialog.setContentView(R.layout.alert_dialog);
		...
		public void onRequestTime() {
			TRACE.d("onRequestTime+要求终端时间。已回覆");
			dismissDialog();
...
//				nfcIndex++;
//				if (nfcIndex==1) {//a0a40000022fe2//a0b000000a
//					sendMsg(11);
//				}else if (nfcIndex==2){
//					sendMsg(12);
//				}
		...
		public void onReturnPowerOnNFCResult(boolean result, String ksn,
			...
			if(result) {
				apduBtn.setEnabled(true);
//				statusEditText.setText(getString(R.string.power_on_icc_success));
				String content = "";
				content += getString(R.string.power_on_icc_success) + "\n";
				content += getString(R.string.ksn) + ksn + "\n";
...
//					apduString = "a0a40000023f00";//a0a40000022fe2//a0b000000a
					...
					/*byte emvPrevalidationApdu[] = { 0x00, (byte)0xA4, 0x04, 0x00, 0x0E
					    , '2', 'P', 'A', 'Y', '.', 'S', 'Y', 'S', '.', 'D', 'D', 'F', '0', '1', 0x00 };

					byte emvPrevalidationApdu1[] = {0x00, (byte)0xB2, 0x01, 0x0C, 0x00};

					byte emvPrevalidationApdu2[] = {0x00, (byte)0xA4, 0x04, 0x00, 0x08, (byte)0xA0, 0x00, 0x00,0x03, 0x33, 0x01, 0x01, 0x01};

					byte emvPrevalidationApdu3[] = {0x00, (byte)0xB2, 0x01, 0x0C, 0x00};
					switch (nfcIndex) {
					case 0:
						apduString = QPOSUtil.byteArray2Hex(emvPrevalidationApdu);
						pos.sendApduByNFC(apduString, 5);
						nfcIndex++;
						break;
					case 1:
						apduString = QPOSUtil.byteArray2Hex(emvPrevalidationApdu1);
						pos.sendApduByNFC(apduString, 5);
						nfcIndex++;
						break;
					case 2:
						apduString = QPOSUtil.byteArray2Hex(emvPrevalidationApdu2);
						pos.sendApduByNFC(apduString, 5);
						nfcIndex++;
						break;	
					case 3:
						apduString = QPOSUtil.byteArray2Hex(emvPrevalidationApdu3);
						pos.sendApduByNFC(apduString, 5);
						nfcIndex++;
						break;	
					default:
						statusEditText.setText("Please power off nfc");
						break;
					}*/
    ...
    private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case 11://a0a40000022fe2//a0b000000a
				pos.sendApdu("a0a40000022fe2");
				break;
			case 12:
				pos.sendApdu("a0b000000a");
				break;
			case 2200:
				try {
					Thread.sleep(1000);
